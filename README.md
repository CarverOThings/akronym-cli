# akronym-cli
Akronym is a Rust command-line tool for managing a dictionary of IT/Technology definitions. It allows users to input new definitions and query existing definitions using acronyms. The program uses the rusqlite library for database interaction and is designed with simplicity in mind.
